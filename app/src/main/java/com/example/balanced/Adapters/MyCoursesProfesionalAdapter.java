...
public class MyCoursesProfesionalAdapter extends RecyclerView.Adapter<MyCoursesProfesionalAdapter.ViewHolder> {
    private ArrayList<Course> dataset;
    private Context context;

    public MyCoursesProfesionalAdapter(){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyCoursesProfesionalAdapter.ViewHolder(view);
    }
